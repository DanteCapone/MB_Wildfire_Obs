...
imagesc(squeeze(results_grid.anomalies(:,:,1,1)))
%% Plot climatologies
...
xlim([0 366])
ylabel(['BC Surface',newline(),'Mass Concentration [g/m^3]'])


% set(gcf,'Position',[-400 1200 1600 600])
set(gcf,'Position',[-100 1000 1600 600])

saving=1;
if saving==1
    saveas(gcf, ["C:\Users\Dante Capone\OneDrive\Desktop\Scripps_PhD\Wildfire_Obs\MB_Wildfire_Obs\figures\satellite_chl\satellite_chl_climatology_5day_MB_fire_years_with_merra.png"]);
    saveas(gcf, ["C:\Users\Dante Capone\OneDrive\Desktop\Scripps_PhD\Wildfire_Obs\MB_Wildfire_Obs\figures\satellite_chl\satellite_chl_climatology_5day_MB_fire_years_with_merra.pdf"]);
end
saving=0;
...
start_year=2003;
end_year=2020;
satellite_all_2020=satellite_all(satellite_all.datetime_merra_bc_plt.Year>=start_year & satellite_all.datetime_merra_bc_plt.Year <= end_year,:);
x=satellite_all_2020.anomaly;
y=satellite_all_2020.Chlorophyll;

% Initialize variables to store coefficients and lags

start_date_plot=satellite_all_2020.datetime_merra_bc_plt(1);
end_date_plot=satellite_all_2020.datetime_merra_bc_plt(end);
...
hold on 
yyaxis right
plot(satellite_chl_MB.datetime,satellite_chl_MB.Chlorophyll)
plot(satellite_all_2020.Chlorophyll)
