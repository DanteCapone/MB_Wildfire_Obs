...
text(148,1.5,["Indians Fire"+newline+"(Monterey, 2008)"],"Color",colorz(1,:))
text(175,3.8,["Soberanes Fire"+newline+"(Monterey, 2016)"],"Color",colorz(2,:))
text(200,5,["SCU Lightning Complex Fire"+newline+"(Santa Cruz, 2020)"],"Color",colorz(3,:))
...
ylabel(['Black Carbon Surface',newline(),'Mass Concentration [kg/m^3]'])
