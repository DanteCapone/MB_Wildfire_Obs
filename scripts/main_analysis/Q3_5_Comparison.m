%% Similar Event Comparison. Use NMDS and clustering to identify similar events, then plots composiiton of 
% wildfire diatom assemblage across events
...
set(gcf, 'Units', 'inches', 'Position', [0, 0, 5, 2]);  % 7.16 inches width and 4 inches height for good aspect ratio
...
saving = 1;
if saving == 1
    print(gcf, '-dpng', '-r1200', 'C:\Users\Dante Capone\OneDrive\Desktop\Scripps_PhD\Wildfire_Obs\MB_Wildfire_Obs\figures\comparative_analysis\taxa_abundance_june2018.png');
    print(gcf, '-dpdf', '-r1200', 'C:\Users\Dante Capone\OneDrive\Desktop\Scripps_PhD\Wildfire_Obs\MB_Wildfire_Obs\figures\comparative_analysis\taxa_abundance_june2018.pdf');
end
...
%By datenum
start_date_datenum = datenum(shade_start);
end_date_datenum = datenum(shade_end);
czu_date_datenum=datenum(czu_date);
lag_date_datenum = datenum(lag_date);
august_date_datenum = datenum(august_date);

%For shading
shade_start_datenum = datenum(shade_start);
shade_end_datenum = datenum(shade_end);
...
if saving == 1
    print(gcf, '-dpng', '-r300', "C:\Users\Dante Capone\OneDrive\Desktop\Scripps_PhD\Wildfire_Obs\MB_Wildfire_Obs\figures\comparative_analysis\group1_anomalies_june2018.png");
    print(gcf, '-dpng', '-r300', "C:\Users\Dante Capone\OneDrive\Desktop\Scripps_PhD\Wildfire_Obs\MB_Wildfire_Obs\figures\comparative_analysis\group1_anomalies_june2018.pdf");
end
...
saving = 1;
if saving == 1
    print(gcf, '-dpng', '-r300', 'C:\Users\Dante Capone\OneDrive\Desktop\Scripps_PhD\Wildfire_Obs\MB_Wildfire_Obs\figures\comparative_analysis\group2_anomalies_2018.png');
    print(gcf, '-dpdf', '-r300', 'C:\Users\Dante Capone\OneDrive\Desktop\Scripps_PhD\Wildfire_Obs\MB_Wildfire_Obs\figures\comparative_analysis\group2_anomalies_2018.pdf');
end
...
% Adjust figure size for double-column width and aspect ratio (for L&O)
set(gcf, 'Units', 'inches', 'Position', [0, 0, 4.5, 2.5]);  % 7.16 inches width and 4 inches height for good aspect ratio
set(gcf, 'PaperPositionMode', 'auto');  % Ensure the figure fits the paper size
